...
struct Messages: View {
    ...
    @Binding private var isCoach: Bool
    
    private var interestedFiltered: [(String, Message, ProfileID)] {
        rootView.profile.interestedCoaches.compactMap { coach in
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text(isCoach ? "Messaged Athletes:":"Interested Coaches:")
                .font(.headline)
                .padding([.leading, .top])
            ...
            Text(isCoach ? "My Athletes:":"My Coaches:")
                .font(.headline)
                .padding([.leading, .top])
